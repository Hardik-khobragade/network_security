...
class DataIngestionConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.collection_name: str = training_pipeline.DATA_INGESTION_COLLECTOR_NAME
...
class DataValidationConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.drift_report = os.path.join(self.data_validation_dir,training_pipeline.DATA_VALIDATION_DRIFT_REPORT_DIR,
...
class ModelTraninerConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.trained_model_file_path: str = os.path.join(
            self.model_trainer_dir, training_pipeline.MODEL_TRAINING_TRAIN_MODEL_NAME, 
            training_pipeline.MODEL_FILE_NAME
        )
        self.expected_accuracy: float = training_pipeline.MODEL_TRAINING_EXPECTED_SCORE
        self.overfitting_underfitting_threshold = training_pipeline.MODEL_TRAINING_OVERFITTING_UNDERFITTING_THERSHOLD