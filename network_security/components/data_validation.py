...
from network_security.entity.artifact_entity import DataIngestionArtifacts,DataValidationArtifacts
...
class DataValidation:
    ...
    def validate_number_of_columns(self,dataframe:pd.DataFrame)->bool:
        try:
            ...
            logging.info(f"Number of columns shoulbe be {number_of_columns}")
            logging.info(f"The number of columns in dataframe {len(dataframe.columns)}")
    ...
    def initiate_data_validation(self)->DataIngestionArtifacts:
        try:
            ...
            data_validation_artifact = DataValidationArtifacts(
                valid_status=status,
                valid_train_file_path=self.data_ingestion_artifacts.training_file_path,
                valid_test_file_path=self.data_ingestion_artifacts.testing_file_path,
